...
def train_arima(target_data, order):
    ...
    predictions = model_fit.predict(
        start=train_size, end=len(target_data) - 1, typ="levels"
    )
...
if __name__ == "__main__":
    ...
    (
        ...
        pred_time_arima,
        arima_size_kb,
    ) = train_arima(stationary_target_data, order=order)
    (
        mae_ha,
        mse_ha,
        rmse_ha,
        ...
        ha_size_kb,
        pred_time_HA,
    ) = historical_average(stationary_target_data)
    ...
    (
        ...
        mape_arima_12,
        r2_arima_12,
    ) = recursive_arima(stationary_target_data, order, forecast_horizon=12)
    (
        mae_ha_12,
        mse_ha_12,
        rmse_ha_12,
        mape_ha_12,
        r2_ha_12,
    ) = historical_average_multistep(stationary_target_data, steps=12)
